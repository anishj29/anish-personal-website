...
export default function Experience() {
  return (
    <div className="pt-20 pb-10 experience-container bg-white">
      <h1 className="text-3xl mb-5">My Experience</h1>
      ...
      <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
          ...
          <li class="mb-10 ms-4 experience-box">
              ...
              <ul class="list-disc">
                ...
                <li>Explored modern website design principles and implemented them on Vact’s website using Wordpress
                </li>
                <li>Designed app screenshots using Figma and conceptualized marketing strategies for user acquisition 
                </li>
              </ul>
          </li>
          <li class="mb-10 ms-4 experience-box">
              ...
              <ul class="list-disc">
                ...
                <li>Discussed product design with co-founders and aided development of AI algorithm that would actively adapt test
                questions to suit specific user’s skill level
                </li>
                <li>Deployed tech stack consisting of Vue JS, HTML, CSS, Tailwind, Python, Postman
                </li>
                <li>Designed wireframes for new website features using Figma and implemented testing protocols using Postman
                </li>
              </ul>
          </li>
      </ol>
