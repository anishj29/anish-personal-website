    ...
    <div className="projects-section pt-16 sm:pt-24 pb-16 sm:pb-24 projects-container w-full bg-gradient-to-br from-cyan-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent mb-4 sm:mb-6">
            Projects
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-cyan-100 font-light max-w-2xl mx-auto leading-relaxed px-4">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
                  <div className="p-2 sm:p-3 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg sm:rounded-xl group-hover:scale-110 transition-transform duration-300">
                    {project.component && (
                      <project.component 
                        style={{ fontSize: 24 }} 
                ...
                <div className="mb-4 sm:mb-6">
                  <p className="text-cyan-100 leading-relaxed text-base sm:text-lg">
                    {project.description}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs sm:text-sm font-semibold text-cyan-300 uppercase tracking-wide">
                    Tech Stack:
                  </span>
                  <span className="text-xs sm:text-sm text-cyan-100 font-medium">
                    {project.techStack}
                  </span>
                </div>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <p className="text-cyan-200 text-base sm:text-lg mb-4">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25"
          >
            View GitHub Profile
