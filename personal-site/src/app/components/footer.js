  ...
  return (
    <div className="footer w-full bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-10 left-10 w-64 h-64 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"></div>
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5 animate-pulse"></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Full-stack developer passionate about creating innovative solutions and building meaningful applications.
            </p>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-center md:justify-start space-x-3">
                ...
                <a 
            href="mailto:anishj2900@gmail.com"  className="text-gray-300">anishj2900@gmail.com</a>
              </div>
              <div className="flex items-center justify-center md:justify-start space-x-3">
                <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-300">New Jersey, USA</span>
              </div>
            </div>
          </div>
        </div>
