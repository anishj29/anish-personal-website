  ...
  return (
    <div className='footer flex justify-center bg-white mt-40 pb-40 w-full experience-container'>
      <div className="text-black text-center flex flex-row mt-40">
        ...
        <div className="intro-box align-middle text-left">
          ...
          <p className="mt-2">Outside of my technical work, I’m actively involved in extracurriculars like Rutgers Mobile App Development club and the Competitive Programming club, both of which help sharpen my problem-solving abilities. I’m also passionate about hackathons, and my team even won first place at the 2024 HackRU Hackathon. In my free time, I love diving into personal projects and always look for new ways to grow my technical skills.</p>
        </div>
      </div>
    </div>
  );
